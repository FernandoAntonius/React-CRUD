...
export default function Logout({ setToken }) {
  ...
  useEffect(() => {
    ...
    setToken(null); // Menghapus token di state App Component
    navigate("/"); // Redirect pengguna ke halaman login setelah berhasil logout
  }, [navigate, setToken]); // Dependensi 'navigate' untuk menghindari peringatan linting
